...
<template>
    <div>
        <div class="about-detail">
            ...
            <div class="about-detail-operate">
                ...
                <div :class="['about-detail-operate-share', { 'active': isIcon }]">
                    <SvgIcon class="icon" name="share" :width="'26px'" :height="'26px'" @click="openIcon" />
                    <div class="reach">
                        <a href="#">
            ...
            <div class="about-detail-related">
                ...
                <div class="about-detail-related-content">
                    <a class="item" href="#" v-for="i in 4" :key="i">
                        <img src="https://q3.itc.cn/q_70/images03/20241013/d3a77cba5a074744905d0c49aa480487.jpeg"
                            alt="">
        ...
        <!-- 分页 -->
        <ul class="about-pagination">
            <li class="about-pagination-item">
                <a href="#">上一篇</a>
            </li>
            <li class="about-pagination-item">
                <a href="#">下一篇</a>
        ...
        <div class="about-comment">
            <h3 class="about-comment-title">评论 </h3>
            <div class="about-comment-close">
                <SvgIcon class="icon" name="sina" :width="'18px'" :height="'18px'" />
